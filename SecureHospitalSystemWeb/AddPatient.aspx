<%@ Page Title="" Language="C#" MasterPageFile="~/ComplianceMaster.Master" AutoEventWireup="true" CodeBehind="AddPatient.aspx.cs" Inherits="DoctorAppointmentWeb.AddPatient" %>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label></label>
                                <div class="form-group">
                                    <asp:Button runat="server" ID="btnSavePatient" Text="Save Patient" CssClass="btn btn-block btn-success" OnClick="btnSavePatient_Click" />
                                </div>
                            </div>
                        </div>
                        <!-- /.row -->
